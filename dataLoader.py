...
def loadData_ratings():
    ...
    columns = ['Date of Entry', 'Name','Rummikub', 'Trial by Trolley','Sequence', 'Galaxy Trucker', 'Rat-a-tat Cat', 'Quacks of Quedlinberg', 'Uno', 'Phase 10', 'Goat Lords', 'Taboo', 'Qwixx', 'Smart Ass', 'Anomia', 'Spades', 'President', 'ERS', 'Love Letter', 'Codenames', 'Peptide', 'Hangry', "That's Pretty Clever", '5 Second Rule', 'Exploding Kittens', 'Llamas Unleashed', 'Carcassonne', 'Uno Flip', 'Bananagrams', 'Betrayal at the House on the Hill', 'Blokus', 'Azul', 'Calico', 'Unearth', 'Hearts', 'Dominion', 'Happy Little Dinosaurs', 'Balderdash', 'Pictionary', 'Sushi Go Dice', 'Fairy Tale', 'Settlers of Catan', '5 Alive', 'Poetry for Neanderthals', 'Least count', "Kings in the Corner", 'Infinity Gauntlet', 'Ten', 'Silver and Gold', 'King of Tokyo', 'Five Crowns', 'Long Shot', 'Bloom', 'Forbidden Desert', 'The Initiative', 'Horrified', 'Hanabi', 'Arkham Horror', 'Mysterium', 'Control', 'Coup', 'Jenga', 'Towers of Arkhanos', 'Dune', 'The Crew: Quest for Planet Nine', 'Superfight']
...
def processResults(data, overall_only = False):
    ...
    if not overall_only:
        ...
        scores_dict["Win Condition"], gplayed_dict["Win Condition"], fraction_dict["Win Condition"], pae_dict["Win Condition"] = getDictionaries("Win Condition", "Win Condition", overall_scores, games_played, overall_fraction)
        
                        
        #get luck score specific results
        scores_dict["Luck Score"], gplayed_dict["Luck Score"], fraction_dict["Luck Score"], pae_dict["Luck Score"] = getDictionaries("Luck Score", "Luck Score", overall_scores, games_played, overall_fraction)
